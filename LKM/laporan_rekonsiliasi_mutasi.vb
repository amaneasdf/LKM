...
Public Class laporan_rekonsiliasi_mutasi
    ...
    Private Sub laporan_rekonsiliasi_mutasi_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        hapustemp()
        Me.Dispose()
    End Sub

    Private Sub laporan_rekonsiliasi_mutasi_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Dispose()
        End If
    End Sub
    Private Sub laporan_rekonsiliasi_mutasi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub report()
        ...
        da.SelectCommand = New MySqlCommand("SELECT * FROM temp_neraca WHERE temp_username='" & MDIParent1.username.Text & "' " & txt & " ORDER BY temp_id ASC", koneksi)
    ...
    Sub data_neraca()
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            If dt.Rows(i)("perkiraan_d_or_k") = "D" Then
                mutasi = Val(saldo_debet) - Val(saldo_kredit)
            ElseIf dt.Rows(i)("perkiraan_d_or_k") = "K" Then
                mutasi = Val(saldo_kredit) - Val(saldo_debet)
            End If

            cd = New MySqlCommand("INSERT INTO temp_neraca VALUES ('" & i + 1 & "','" & dt.Rows(i)("perkiraan_kode") & "','" & dt.Rows(i)("perkiraan_umum") & "', '" & dt.Rows(i)("perkiraan_nama") & "', '" & saldo_awal & "', '" & saldo_debet & "', '" & saldo_kredit & "', '" & mutasi & "', '" & saldo_akhir & "', '" & jenis & "', '" & MDIParent1.username.Text & "')", koneksi)
            cd.ExecuteNonQuery()
        Next
    End Sub
    ...
    Sub data_labarugi()
        ...
        For i As Integer = 0 To dt.Rows.Count - 1
            ...
            If dt.Rows(i)("perkiraan_d_or_k") = "D" Then
                mutasi = saldo_debet - saldo_kredit
            ElseIf dt.Rows(i)("perkiraan_d_or_k") = "K" Then
                mutasi = saldo_kredit - saldo_debet
            End If
