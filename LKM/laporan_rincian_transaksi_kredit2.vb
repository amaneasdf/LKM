...
Public Class laporan_rincian_transaksi_kredit2

    Private Sub laporan_rincian_transaksi_kredit2_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub laporan_rincian_transaksi_kredit2_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Dispose()
        End If
    End Sub

    Private Sub laporan_rincian_transaksi_kredit2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub report()
        ...
        da.Fill(ds.Tables("rincian_transaksi_kredit2"))

        ReportViewer1.ProcessingMode = ProcessingMode.Local
        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", ds.Tables("rincian_transaksi_kredit2")))
