...
Public Class laporan_nominatif_tabungan

    Private Sub laporan_nominatif_tabungan_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        cd = New MySqlCommand("DELETE FROM temp_nominatif_tabungan WHERE temp_username='" & MDIParent1.username.Text & "'", koneksi)
        cd.ExecuteNonQuery()
        Me.Dispose()
    End Sub

    Private Sub laporan_nominatif_tabungan_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Dispose()
        End If
    End Sub
    Private Sub laporan_nominatif_tabungan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub report()
        ...
        ds = New DATASET
        da.SelectCommand = New MySqlCommand(cetak_nominatif_tabungan.TextBox1.Text, koneksi)
        da.Fill(ds.Tables("nominatif_tabungan"))

        ReportViewer1.ProcessingMode = ProcessingMode.Local
        ReportViewer1.LocalReport.DataSources.Clear()
        ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", ds.Tables("nominatif_tabungan")))
        ...
        param(2) = New ReportParameter("tanggal", "Periode " + Format(cetak_nominatif_tabungan.DateTimePicker1.Value, "dd MMMM yyyy"))
        ...
        param(7) = New ReportParameter("pengelompokan", cetak_nominatif_tabungan.TextBox2.Text)
